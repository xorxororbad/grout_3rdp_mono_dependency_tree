...
set(ARTIFACT_PATH ${SQLITE_INSTALL_PATH}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sqlite3${CMAKE_STATIC_LIBRARY_SUFFIX})
...
ExternalProject_Add(sqlite3_from_src
    ...
    DOWNLOAD_COMMAND    ""
    CONFIGURE_COMMAND
        <SOURCE_DIR>/configure --prefix= --enable-static --disable-shared
    BUILD_COMMAND
        make
    INSTALL_COMMAND
        make install DESTDIR=${SQLITE_INSTALL_PATH}
    ...
    BUILD_BYPRODUCTS ${ARTIFACT_PATH}
)
